...
- Deploying metadata to orgs → [platform-metadata-deploy](<skill:platform-metadata-deploy — plugin sf-platform>/SKILL.md)
- Writing Apex token-handling code → [platform-apex-generate](<skill:platform-apex-generate — plugin sf-platform>/SKILL.md)
...
| Deploy app metadata | [platform-metadata-deploy](<skill:platform-metadata-deploy — plugin sf-platform>/SKILL.md) | org validation and deployment |
| Apex token or refresh handling | [platform-apex-generate](<skill:platform-apex-generate — plugin sf-platform>/SKILL.md) | implementation logic |
