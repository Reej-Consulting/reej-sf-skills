...
| Call an external API from Apex or Flow logic | [platform-apex-generate](../platform-apex-generate/SKILL.md) or [integration-connectivity-generate](<skill:integration-connectivity-generate — plugin sf-integration>/SKILL.md) |
